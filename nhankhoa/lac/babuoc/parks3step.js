...
function crossoutMuscles (eliminated) {
  ...
  var muscleNames = [
  "Cơ chéo trên mắt phải", 
  "Cơ trực trên mắt phải", 
  "Cơ trực dưới mắt phải", 
  "Cơ chéo dưới mắt phải", 
  "Cơ chéo trên mắt trái", 
  "Cơ trực trên mắt trái", 
  "Cơ trực dưới mắt trái", 
  "Cơ chéo dưới mắt trái"];
  ...
  if (remainingMuscles.length == 1) {
  	...
  	jQuery("#d_answer").html("<b>Kết quả:</b> Cơ bị yếu liệt là <b>" + longName + "</b>");
