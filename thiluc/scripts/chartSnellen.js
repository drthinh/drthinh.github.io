...
{
	switch(index) {
	case ChartSnellen.OPTO_LETTER:		return "Chữ cái";
	case ChartSnellen.OPTO_HTOV:  		return "HTOV";
	case ChartSnellen.OPTO_PICS: 		return "Hình ảnh";
	case ChartSnellen.OPTO_NUMBERS:  	return "Chữ số";
	case ChartSnellen.OPTO_TUMBLINGES:  return "Bảng chữ E";
	case ChartSnellen.OPTO_LANDOLTC:	return "Bảng chữ C";
	case ChartSnellen.OPTO_LEA:			return "Ký hiệu";
	}
}
