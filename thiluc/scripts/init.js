function Boot() {
    ...
    $("#lineSize").on("keyup paste input", function(e) { e.stopPropagation();
        WriteURL(); });
    $("#distanceSize").on("keyup paste input", function(e) { e.stopPropagation();
        WriteURL(); });
...
window.OnKeyDown = function(e) {
    ...
    switch (e.keyCode) {
        ...
        case 13:
            ...
            /* F1 */
        case 112:
            settings.chartType.value = "0";
            break;
            /* F2 */
        case 113:
            settings.chartType.value = "1";
            break;
            /* F3 */
        case 114:
            settings.chartType.value = "2";
            break;
            /* F4 */
        case 115:
            settings.chartType.value = "3";
            break;
            /* F5 */
        case 116:
            settings.chartType.value = "4";
            break;
            /* F6 */
        case 118:
            settings.chartType.value = "5";
            break;
            /* F7 */
        case 117:
            settings.chartType.value = "6";
            break;
            /* F8 */
        case 119:
            settings.chartType.value = "7";
            break;
            /* F9 */
        case 120:
            settings.chartType.value = "8";
            break;
            /* F10 */
        case 121:
            settings.chartType.value = "9";
            break;

            /* q */
        case 81:
            settings.displayType.value = "0";
            break;
            /* w */
        case 87:
            settings.displayType.value = "1";
            break;
            /* e */
        case 69:
            settings.displayType.value = "2";
            break;
            /* r */
        case 82:
            settings.displayType.value = "3";
            break;

            /* 1 */
        case 49:
            settings.optoType.value = "0";
            break;
            /* 2 */
        case 50:
            settings.optoType.value = "1";
            break;
            /* 3 */
        case 51:
            settings.optoType.value = "2";
            break;
            /* 4 */
        case 52:
            settings.optoType.value = "3";
            break;
            /* 5 */
        case 53:
            settings.optoType.value = "4";
            break;
            /* 6 */
        case 54:
            settings.optoType.value = "5";
            break;
            /* 7 */
        case 55:
            settings.optoType.value = "6";
            break;
            /* 8 */
        case 56:
            settings.optoType.value = "7";
            break;
            /* 9 */
        case 57:
            settings.optoType.value = "8";
            break;
            /* 0 */
        case 48:
            settings.optoType.value = "9";
            break;

            /* m */
        case 77:
            settings.mirror.checked = !settings.mirror.checked;
            break;
            /* a */
        case 65:
            settings.animate.checked = !settings.animate.checked;
            break;
            /* b */
        case 66:
            settings.crowd.checked = !settings.crowd.checked;
            break;
        default:
            change = false;
    }
